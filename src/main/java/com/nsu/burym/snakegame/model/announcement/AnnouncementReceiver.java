package com.nsu.burym.snakegame.model.announcement;
...
public class AnnouncementReceiver implements Runnable {
        ...
        while(!Thread.currentThread().isInterrupted()) {
            ...
            while ((timeInterval = System.currentTimeMillis() - currentTime) <= RECEIVE_TIME &&
               ...
               //     System.out.println(gameMessage);
                    ...
                    addNewGame(new IpAddress(receivedPacket.getAddress().getHostAddress()), receivedPacket.getPort(), gameMessage.getAnnouncement());
    ...
    private void addNewGame(IpAddress ipAddress, int port, SnakesProto.GameMessage.AnnouncementMsg gameAnnouncementMessage) {
        ...
        if (availableGames.containsValue(gameAnnouncementMessage)) {
